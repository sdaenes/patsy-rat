  ...
  const doc = new Document({
    sections: [{
      ...
      children: [
        ...
        new Table({
          width: { size: PAGE_WIDTH, type: WidthType.DXA },
          columnWidths: [PAGE_WIDTH / 3, PAGE_WIDTH / 3, PAGE_WIDTH / 3],
          rows: [
            new TableRow({ children: [
              new TableCell({ borders, width: { size: PAGE_WIDTH/3, type: WidthType.DXA }, shading: { fill: GREEN_DARK, type: ShadingType.CLEAR }, margins: { top: 80, bottom: 80, left: 120, right: 120 }, children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: "ESTIMATIF SUR SITE", bold: true, size: 18, color: WHITE, font: "Arial" })] })] }),
              new TableCell({ borders, width: { size: PAGE_WIDTH/3, type: WidthType.DXA }, shading: { fill: GREEN_DARK, type: ShadingType.CLEAR }, margins: { top: 80, bottom: 80, left: 120, right: 120 }, children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: "RÉGULÉS (abattus)", bold: true, size: 18, color: WHITE, font: "Arial" })] })] }),
              new TableCell({ borders, width: { size: PAGE_WIDTH/3, type: WidthType.DXA }, shading: { fill: GREEN_DARK, type: ShadingType.CLEAR }, margins: { top: 80, bottom: 80, left: 120, right: 120 }, children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: "RAMASSÉS (carcasses)", bold: true, size: 18, color: WHITE, font: "Arial" })] })] }),
            ]}),
            new TableRow({ children: [
              new TableCell({ borders, width: { size: PAGE_WIDTH/3, type: WidthType.DXA }, margins: { top: 100, bottom: 100, left: 120, right: 120 }, children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [val(data.nbEstimatif || "—")] })] }),
              new TableCell({ borders, width: { size: PAGE_WIDTH/3, type: WidthType.DXA }, margins: { top: 100, bottom: 100, left: 120, right: 120 }, children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [val(data.nbRegules || "—")] })] }),
              new TableCell({ borders, width: { size: PAGE_WIDTH/3, type: WidthType.DXA }, margins: { top: 100, bottom: 100, left: 120, right: 120 }, children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [val(data.nbRamasses || "—")] })] }),
            ]}),
          ]
        }),
        spacer(),
