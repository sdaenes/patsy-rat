    ...
    sections: [{
      ...
      children: [
        ...
        new Paragraph({ spacing: { before: 60, after: 60 }, children: [
          label("Equarissage pris en charge par : "),
          val(
            data.gestionClient && data.gestionEntreprise ? "Le client & Patsy-Rat" :
            data.gestionClient ? "Le client" :
            data.gestionEntreprise ? "Patsy-Rat" : "—"
          )
        ] }),
        spacer(),
        ...
        // 8. VALIDATION
        sectionTitle("8. Commentaires"),
        spacer(),
        new Paragraph({ spacing: { before: 40, after: 40 }, children: [val(data.commentairesClient)] }),
        spacer(),
